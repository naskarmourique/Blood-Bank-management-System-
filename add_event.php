...
<head>
    ...
    <title>Add Event - BloodConnect</title>
    ...
    <div class="main-wrapper">
        <div class="form-container">
            <div class="form-header">
                <h2><i class="fas fa-plus-circle icon"></i> Add New Event</h2>
                ...
                <form action="insert_event.php" method="post">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="adminEventName" name="event_name" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="adminEventLocation" name="location" required>
                        </div>
                        <div class="col-md-6">
                            <label for="adminEventDate" class="form-label">Date *</label>
                            <input type="date" class="form-control" id="adminEventDate" name="event_date" required>
                        </div>
                        <div class="col-md-3">
                            <label for="adminStartTime" class="form-label">Start Time *</label>
                            <input type="time" class="form-control" id="adminStartTime" name="start_time" required>
                        </div>
                        <div class="col-md-3">
                            <label for="adminEndTime" class="form-label">End Time *</label>
                            <input type="time" class="form-control" id="adminEndTime" name="end_time" required>
                        </div>
                        <div class="col-md-6">
                            <label for="adminOrganizer" class="form-label">Organizer</label>
                            <input type="text" class="form-control" id="adminOrganizer" name="organizer">
                        </div>
                        <div class="col-md-6">
                            <label for="adminContactPerson" class="form-label">Contact Person</label>
                            <input type="text" class="form-control" id="adminContactPerson" name="contact_person">
                        </div>
                        <div class="col-md-4">
                            <label for="adminTargetDonors" class="form-label">Target Donors *</label>
                            <input type="number" class="form-control" id="adminTargetDonors" name="target_donors" min="0" value="0" required>
                        </div>
                        <div class="col-md-4">
                            <label for="adminRegisteredDonors" class="form-label">Registered Donors *</label>
                            <input type="number" class="form-control" id="adminRegisteredDonors" name="registered_donors" min="0" value="0" required>
                        </div>
                        <div class="col-md-4">
                            <label for="adminDonatedUnits" class="form-label">Donated Units *</label>
                            <input type="number" class="form-control" id="adminDonatedUnits" name="donated_units" min="0" value="0" required>
                        </div>
                        <div class="col-12">
                            <label for="adminEventDescription" class="form-label">Description</label>
                            <textarea class="form-control" id="adminEventDescription" name="description" style="height: 100px; resize: none;"></textarea>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" class="btn-submit" name="submit"><i class="fas fa-plus"></i> Add Event</button>
                    </div>
                </form>
            </div>
        </div>
